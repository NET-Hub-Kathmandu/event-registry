...
This Code of Conduct addresses our standards and expectations for conduct at .NET Hub Kathmandu events.

## Code of Conduct

By attending a .NET Hub Kathmandu event, including any of the events or activities organized by .NET Hub Kathmandu, you represent that you have read, understand, and agree to the following .NET Hub Kathmandu Event Code of Conduct (hereinafter “Code of Conduct”). This Code of Conduct applies to all attendees, speakers, exhibitors, sponsors, organizers, staff, and volunteers (collectively “Event Participants”) at the Event.

.NET Hub Kathmandu values the participation of all Event Participants and aims to create an event where all Event Participants have an enjoyable and fulfilling experience. Accordingly, all Event Participants are expected to show respect and courtesy to other Event Participants throughout the Event.

.NET Hub Kathmandu is dedicated to providing a positive and harassment-free experience for everyone, regardless of age, gender, gender identity and expression, sexual orientation, disability, personal appearance, body size, ethnicity, race, religion, nationality, or level of experience.
...
- Sustained disruption of talks or any other events or activities organized by .NET Hub Kathmandu
